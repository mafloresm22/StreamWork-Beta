...
import '@/public/styles/Login/sign-in.css'
...
const SignInPage = () => {
    ...
    return (
        <div className="sign-in-root">
            ...
            <div className="sign-in-branding">
                <div className="sign-in-branding-inner">
                    ...
                    <div className="sign-in-tagline">
                        <h1 className="sign-in-title">Tu espacio de<br />trabajo en vivo</h1>
                        <p className="sign-in-subtitle">
                            Conecta, colabora y transmite con tu equipo
            ...
            {/* Panel derecho — formulario o estado de sesión */}
            <div className="sign-in-form-panel">
                {isLoaded && isSignedIn ? (
                    <div className="sign-in-form-wrapper" style={{ textAlign: 'center' }}>
                        <div className="sign-in-form-header" style={{ marginBottom: '24px' }}>
                            <h2 className="sign-in-form-title" style={{ fontSize: '24px', color: '#1f2937' }}>Sesión activa o expirada</h2>
                            <p className="sign-in-form-description" style={{ marginTop: '8px', color: '#4b5563' }}>
                                Tu navegador tiene una sesión activa, pero es posible que sea necesario actualizar tus credenciales.
                            </p>
                        </div>
                    ...
                    <div className="sign-in-form-wrapper">
                        <div className="sign-in-form-header">
                            <h2 className="sign-in-form-title">Bienvenido de nuevo</h2>
                            <p className="sign-in-form-description">Inicia sesión con tus credenciales</p>
                        </div>
                        ...
                        <SignIn
                            appearance={{
                                ...
                                elements: {
                                    ...
                                    header: { display: 'none' },
                                    // Oculta el footer que tiene el link de registro
                                    footer: { display: 'none' },
